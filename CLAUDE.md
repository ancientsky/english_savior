...
js/
  ...
  data/
    ...
    sky.js              — Sky Citadel world data (SKY_CONFIG, SKY_ISLANDS ×36 incl. 12 galaxy + 8 secret isles, SKY_BRIDGES, SKY_PADS, SKY_PORTALS ×10, SKY_SWITCHES ×4, SKY_QUESTS ×70 incl. 18 hidden sqh_, SKY_MOBS ×9, SKY_SKIN_TINTS)
    game.js             — Achievements (42, each with pts; `hidden` ones show ??? until unlocked), daily quests (12), inventory items (8, usable as charms), shop items (consumables/skins/titles/themes), ACH_POINT_REWARDS, LEVEL_MILESTONES, CHARM_PERKS, SELL_PRICES
reference/
...
- **Achievement points**: derived from unlocked achievements (10/20/40 pts tiers, 850 total); ACH_POINT_REWARDS thresholds grant exclusive titles/skins/themes (state.pointRewardsClaimed)
