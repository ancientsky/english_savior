...
const MusicManager = (() => {
  ...
  const ZONE_TRACKS = {
    hub: 'home', youtube: 'home', daily: 'home',
    sky: 'explore', listening: 'explore', speak: 'explore',
    rpg: 'story', builder: 'story',
    minecraft: 'playful', candy: 'playful', sling: 'playful',
    tower: 'battle', empire: 'battle', roblox: 'battle', spelling: 'battle',
  };
  ...
  function setEnabled(value) {
    ...
    if (!value) {
      ...
      const id = currentId || ZONE_TRACKS[lastZone] || 'home';
