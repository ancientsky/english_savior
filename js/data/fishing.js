...
const FISH_SPECIES = [
  ...
  { id: 'torch',    emoji: '🔥', word: 'TORCH',    zh: '火把',     rarity: 2, pond: 5 },
  ...
  { id: 'walrus',     emoji: '🐺',  word: 'ARCTICWOLF', say: 'arctic wolf', zh: '北極狼', rarity: 1, pond: 6 },
  ...
  { id: 'stingray',   emoji: '🪼', word: 'GLOWJELLY',  say: 'glow jelly', zh: '發光水母', rarity: 2, pond: 8 },
  ...
  { id: 'origami',   emoji: '🪭', word: 'FOLDINGFAN',   say: 'folding fan', zh: '摺扇',     rarity: 2, pond: 10 },
  ...
  { id: 'knight',       emoji: '🏇', word: 'KNIGHT',       zh: '騎士',     rarity: 1, pond: 16 },
  ...
  { id: 'trumpet',      emoji: '📯', word: 'HORN',         zh: '號角',     rarity: 1, pond: 16 },
  { id: 'banner',       emoji: '🚩', word: 'BANNER',       zh: '旗幟',     rarity: 2, pond: 16 },
  { id: 'catapult',     emoji: '🏹', word: 'ARROW',        zh: '箭',       rarity: 2, pond: 16 },
  ...
  { id: 'toucan',      emoji: '🦤', word: 'DODO',        zh: '渡渡鳥',   rarity: 1, pond: 17 },
  ...
  { id: 'cannon',      emoji: '🪢', word: 'ROPE',        zh: '繩索',     rarity: 1, pond: 19 },
  { id: 'pirate',      emoji: '🏴‍☠️', word: 'PIRATE',      zh: '海盜',     rarity: 1, pond: 19 },
  { id: 'skullflag',   emoji: '💀', word: 'SKULLFLAG',   say: 'skull flag', zh: '骷髏旗', rarity: 2, pond: 19 },
  ...
  { id: 'seashell',       emoji: '🦪', word: 'OYSTER',         zh: '牡蠣', rarity: 1, pond: 20 },
  ...
  { id: 'shrine',      emoji: '🛕', word: 'SHRINE',      zh: '神社',     rarity: 1, pond: 21 },
  ...
  { id: 'tightrope',   emoji: '🦁', word: 'LION',        zh: '獅子',     rarity: 2, pond: 22 },
  ...
  { id: 'mummy',        emoji: '🐈‍⬛', word: 'BLACKCAT',    say: 'black cat', zh: '黑貓',   rarity: 1, pond: 23 },
  ...
  { id: 'scarecrow',    emoji: '🌕', word: 'HARVESTMOON',  say: 'harvest moon', zh: '豐收月', rarity: 1, pond: 23 },
  ...
  { id: 'ornament',     emoji: '🔔', word: 'JINGLEBELL',   say: 'jingle bell', zh: '聖誕鈴鐺', rarity: 2, pond: 24 },
