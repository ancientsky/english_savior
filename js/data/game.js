...
const ACHIEVEMENTS = [
  ...
  { id: 'fishing_legend_all', name: '傳說大師', desc: '收服全部 10 隻傳說魚', icon: '👑', pts: 20, condition: s => (s.fishLegendaries || 0) >= 10 },
  { id: 'fishing_dex_full', name: '圖鑑全滿', desc: '水族圖鑑 110 種魚全部收藏', icon: '🌊', pts: 40, hidden: true, condition: s => (s.fishDistinct || 0) >= 110 },
