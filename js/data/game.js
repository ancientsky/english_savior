...
const ACHIEVEMENTS = [
  ...
  { id: 'builder_first', name: '第一座地標', desc: '在句子建築工地蓋好第一座世界知名建築', icon: '🗼', condition: s => (s.builderLandmarks || 0) >= 1 },
  { id: 'builder_world', name: '環遊世界', desc: '在句子建築工地蓋出 10 座世界知名建築', icon: '🌍', condition: s => (s.builderLandmarks || 0) >= 10 },
