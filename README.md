...
| 🖐️ 打字訓練營 | 12 課指法課程＋8 色指法鍵盤，學會雙手盲打 | 打字/指法 |
| 🕵️ 英語偵探社 | 24 件案件讀線索、找說謊者、解密碼、指認兇手 | 閱讀推理 |
...
- **成就系統**：62 個成就（含隱藏成就）共 1,220 點，點數門檻解鎖專屬獎勵
...
- 成就：62 個（10/20/40 點三檔，共 1,220 點；點數門檻贈專屬稱號/造型/主題）
